...
SRC = Image.open("/mnt/user-data/uploads/Gemini_Generated_Image_qxzmaaqxzmaaqxzm.jpeg").convert("RGB")
W, H = SRC.size
CW, CH = W / 4, H / 4
...
foglio.save("/home/claude/gatto.png")
print("foglio gatto", foglio.size, f"({len(finali)} frame da {FW}x{FH})")

big = foglio.resize((foglio.width * 8, foglio.height * 8), Image.NEAREST)
bg = Image.new("RGBA", big.size, (150, 148, 142, 255))
bg.alpha_composite(big); bg.convert("RGB").save("/home/claude/gatto-zoom.png")
