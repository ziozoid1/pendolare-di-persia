...
SRC = Image.open("/mnt/user-data/uploads/Gemini_Generated_Image_xhntoixhntoixhnt.jpeg").convert("RGB")
...
tit.convert("RGB").save("/home/claude/skin-garibaldi2/titolo.png")
